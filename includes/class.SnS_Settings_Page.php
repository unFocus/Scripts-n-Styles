...
class SnS_Settings_Page
{
	...
	static function show_meta_box_field() {
		...
		<fieldset>
			<label>
				<input type="radio" name="sns_options[show_meta_box]" value="yes" id="show_meta_box_0" <?php checked( $sns_options['show_meta_box'], 'yes' ); ?>/>
				<span>Yes</span></label>
			<br />
			<label>
				<input type="radio" name="sns_options[show_meta_box]" value="no" id="show_meta_box_1" <?php checked( $sns_options['show_meta_box'], 'no' ); ?>/>
				<span>No</span></label>
		</fieldset>
	...
	static function restrict_field() {
		...
		<fieldset>
			<label>
				<input type="radio" name="sns_options[restrict]" value="yes" id="restrict_0" <?php checked( $sns_options['restrict'], 'yes' ); ?>/>
				<span>Yes</span></label>
			<br />
			<label>
				<input type="radio" name="sns_options[restrict]" value="no" id="restrict_1" <?php checked( $sns_options['restrict'], 'no' ); ?>/>
				<span>No</span></label>
		</fieldset>
