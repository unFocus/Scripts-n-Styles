...
if ( version_compare( $GLOBALS['wp_version'], '4.7-alpha', '<' ) ) {
	...
	add_action( 'load-customize.php', function() {
		wp_die( sprintf( __( 'Scripts n Styles Theme requires at least WordPress version 4.7. You are running version %s. Please upgrade and try again.', 'scripts-n-styles' ), $GLOBALS['wp_version'] ), '', array(
			'back_link' => true,
		) );
	} );
